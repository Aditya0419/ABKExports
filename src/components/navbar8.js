        ...
        <div data-thq="thq-navbar-nav" className="navbar8-desktop-menu">
          <nav className="navbar8-links1">
            ...
            >
              {props.link1 ?? (
                <Fragment>
                  <span className="navbar8-text21">#home</span>
                </Fragment>
              )}
            </a>
            <a href={props.link2Url} className="thq-body-small thq-link">
              {props.link2 ?? (
                <Fragment>
                  <span className="navbar8-text26">About</span>
                </Fragment>
              )}
            </a>
          ...
          <div className="navbar8-buttons1">
            <a
              href="mailto:abkexports18@gmail.com?subject=Enquire about Prices across range of products"
              className="navbar8-action21 thq-button-animated thq-button-outline"
            >
              <span>
                {props.action2 ?? (
                  <Fragment>
                    <span className="navbar8-text14">Contact Us</span>
                  </Fragment>
                )}
              </span>
            </a>
          ...
          <div className="navbar8-nav">
            ...
            <nav className="navbar8-links2">
              ...
              >
                {props.link3 ?? (
                  <Fragment>
                    <span className="navbar8-text25">#products</span>
                  </Fragment>
                )}
              </a>
                      ...
                      <div className="navbar8-menu-item1">
                        ...
                        <div className="navbar8-content1">
                          <span className="navbar8-page11 thq-body-large">
                            {props.page1 ?? (
                              <Fragment>
                                <span className="navbar8-text13">Home</span>
                              </Fragment>
                            )}
                          </span>
                            ...
                            {props.page1Description ?? (
                              <Fragment>
                                <span className="navbar8-text15">
                                  Welcome to ABK Exports - Your Trusted Export
                                  Partner
                                </span>
                              </Fragment>
                            )}
                            ...
                            {props.page2Description ?? (
                              <Fragment>
                                <span className="navbar8-text18">
                                  Learn more about ABK Exports and our
                      ...
                      <div className="navbar8-menu-item3">
                        ...
                        <div className="navbar8-content3">
                          <span className="navbar8-page31 thq-body-large">
                            {props.page3 ?? (
                              <Fragment>
                                <span className="navbar8-text19">Products</span>
                              </Fragment>
                            )}
                          </span>
                          <span className="thq-body-small">
                            {props.page3Description ?? (
                              <Fragment>
                                <span className="navbar8-text22">
                                  ...
                                  including premium quality Fuller&apos;s Earth.
                                </span>
                              </Fragment>
                            )}
                          </span>
            ...
            <div className="navbar8-buttons2">
              <button className="thq-button-filled">
                <span>
                  {props.action1 ?? (
                    <Fragment>
                      <span className="navbar8-text23">Learn More</span>
                    </Fragment>
                  )}
                </span>
              </button>
                  ...
                  <div className="navbar8-content6">
                    ...
                    <span className="thq-body-small">
                      {props.page2Description ?? (
                        <Fragment>
                          <span className="navbar8-text18">
                            Learn more about ABK Exports and our commitment to
                            quality and service.
                          </span>
                        </Fragment>
                      )}
                  ...
                  <div className="navbar8-content7">
                    ...
                    <span className="thq-body-small">
                      {props.page3Description ?? (
                        <Fragment>
                          <span className="navbar8-text22">
                            Explore our range of organic products, including
                            premium quality Fuller&apos;s Earth.
                          </span>
                        </Fragment>
                      )}
                    </span>
